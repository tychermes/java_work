...
public class Mission02_2 {
	public static void main(String[] args) {
		...
		// 과목평균도 따로 배열 생성 필요 없이 subTotal/score[0].length하면 됨
		int subAvg[] = {0, 0, 0, 0};

		// 학생 총점,학생 평균은 '가로 합': 각 학생인덱스[j]의 각 [i]번째 원소끼리의 합,평균
		// 사실 학생 총점, 학생 평균 배열을 선언할 필요는 없다. 
		// for문이 블록 안에서 그때그때 sum하고 avg계산하면 됨.
		int stdTotal[] = {0, 0, 0};
		...
		//★여기 조건에 score[i].length 하면 왜 안될까??? -> 아.. i=0으로 초기화 해놓고 왜 그래..?
